  ...
  <div className="content-upper">
    <main className="content-upper-main">
      ...
      <div className="panel">
        <div className="panel-header">
          <div className="panel-left">
            <div className="panel-label"><i className="fas fa-sign-in-alt" />Sign In</div>
        ...
        <div className="panel-content">
              ...
              Unable to sign in?
              <Link className="btn btn-link" to="/reset-password"><i className="fas fa-undo-alt" />Reset Password</Link>
            </div>
      ...
      <div className="btn-link-group balance-text">
        ...
        <Link className="btn btn-link" to="/signup"><i className="fas fa-user-plus" />Register</Link>
      </div>
      {/* MAIN AREA END */}
    </main>
  </div>
